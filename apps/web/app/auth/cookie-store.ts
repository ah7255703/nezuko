...
export class SessionStore {
    ...
    private chunk_(cookie: Cookie): Cookie[] {
    ...
    private clean_(): Record<string, Cookie> {
    ...
    chunk(value: string, options: Partial<Cookie["options"]>): Cookie[] {
        ...
        const cookies: Record<string, Cookie> = this.clean_()

        // Calculate new chunks
        const chunked = this.chunk_({
    ...
    clean(): Cookie[] {
        return Object.values(this.clean_())
    }
}